...
<body>
    <div class="sidebar fixed bg-white">
        ...
        <ul class="flex flex-col gap-5">
            ...
            <li><a href="{{ url('reports.index') }}" class="sidebar-item">Report Postingan</a></li>
            <li><a href="{{ url('admin.claim_items.response.index') }}" class="sidebar-item">Pengajuan Claim</a></li>
            <li>
