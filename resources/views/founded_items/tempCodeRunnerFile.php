                ...
                <div class="content p-5">
                    <form action="{{ route('founded_items.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col md:flex-row gap-x-6 gap-y-4">
                        ...
                        <div class="flex flex-col gap-y-4 md:w-1/2">
                            ...
                            <div class="form-group">
                                <label for="item_type" style="color: #080F2B; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 16px; font-style: normal; line-height: 30px; letter-spacing: 0.06px; margin-bottom: 0.25rem; display: block;">Jenis Barang</label>
                        ...
                        <div class="flex flex-col gap-y-4 md:w-1/2">
                            ...
                            <div class="form-group">
                                <label for="item_photo" style="color: #080F2B; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 16px; font-style: normal; line-height: 30px; letter-spacing: 0.06px; margin-bottom: 0.25rem; display: block;">Upload Foto Barang (jika ada)</label>
                                {{-- Changed border-style from dashed to solid --}}

                                <div style="position: relative; width: 100%; height: 150px; border: 2px solid #ededed; border-radius: 12px; background-color: #F9FAFB; cursor: pointer; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center;" onmouseover="this.style.borderColor='#080F2B'; this.style.backgroundColor='#F3F4F6';" onmouseout="this.style.borderColor='#D1D5DB'; this.style.backgroundColor='#F9FAFB';">
