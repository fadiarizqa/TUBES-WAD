...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('lost_items.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col md:flex-row gap-x-6 gap-y-4">
        ...
        <div class="flex flex-col gap-y-4 md:w-1/2">
            ...
            <div class="form-group">
                <label for="lost_item_name" style="color: #080F2B; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 20px; font-style: normal; font-weight: 600; line-height: 30px; letter-spacing: 0.06px; margin-bottom: 0.25rem; display: block;">Nama Barang Hilang</label>
            ...
            <div class="form-group">
                <label for="lost_location" style="color: #080F2B; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 20px; font-style: normal; font-weight: 600; line-height: 30px; letter-spacing: 0.06px; margin-bottom: 0.25rem; display: block;">Lokasi Kehilangan</label>
            ...
            <div class="form-group">
                <label for="lost_date" style="color: #080F2B; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 20px; font-style: normal; font-weight: 600; line-height: 30px; letter-spacing: 0.06px; margin-bottom: 0.25rem; display: block;">Tanggal Kehilangan</label>
